var count_00 = instance_number(obj_lanzador);
var count_01 = instance_number(obj_hostil);

if(hostiles_generado < max_hostiles && hostiles_room < max_hostiles_room){
	if(count == 2){

		show_debug_message("2 lanzadores");
		...
		if(sec >= time){
            ...
            if (posicion_valida) {
                instance_create_layer(x_pos, y_pos, "Instances", obj_lanzador);
